 ...
 * @since 26.11.2003
 */
//核心方法 loadBeanDefinitions(Resource resource);
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    @Nullable
    //获取外部文件的文件流,如xml的xsd或dtd, 首先再本项目的默认路径下查找,没有再去网上下载.
    ...
    //该xmlBeanDefinitionReader中正在加载的Resource容器
    ...
    /**
     * Load bean definitions from the specified XML file.
     * 主方法:  doLoadBeanDefinitions(InputSource inputSource, Resource resource)
     *
    ...
    public int loadBeanDefinitions(EncodedResource encodedResource) throws BeanDefinitionStoreException {
         ...
         * 最后需要操作的步骤如下:
         * 1:需关闭inputSource
         * 2:重复加载Resource 和 从resourcesCurrentlyBeingLoaded.get()中移除该Resource
         * 3:如果resourcesCurrentlyBeingLoaded.get()空,需从ThreadLocal中移除
         */
        try {
     ...
     */
    //Document对象是对xml文档的抽象，InputSource是表示xml文件流,里面含编码,systemId,publicId等等信息
    ...
    public int registerBeanDefinitions(Document doc, Resource resource) throws BeanDefinitionStoreException {
        //BeanDefinitionDocumentReader 用document 来祖册beanDefinition
        BeanDefinitionDocumentReader documentReader = createBeanDefinitionDocumentReader();
        int countBefore = getRegistry().getBeanDefinitionCount();
        //DefaultBeanDefinitionDocumentReader,CreateReaderContent暂不了解
